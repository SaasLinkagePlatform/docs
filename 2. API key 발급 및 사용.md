...
### ** 전자정부 연계 SaaS 서비스의 실제 API 호출 예시 코드는 privateSaasOperationSupportCenter 하위의 develop repo의 linkService/apiCallExample 샘플 코드 참고
- https://github.com/privateSaasOperationSupportCenter/develop/tree/main/linkService/apiCallExample
